...
class SayDays:
    def _init_(self, year: int, month: int, day: int):
        ...
        def weekday_name(self) -> str:
            ...
            return names[self.weekday()] # s -> ""Thursday"
...
while True:
    ...
    data  = SayDays(year, month, day)
    
    print("Days after Jan 1:  ", data.days())
    print("Days until Dec 31:  ", data.days_left())
    print("Numeric day of the week:  ", data.weekday())
    print("English day of the week:  ", data.weekday_name())
